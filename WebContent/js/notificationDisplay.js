...
App2.controller('notificationController', function($scope,$http) {
	...
	//begin code to get notification
	 ...
	 //end code to get notification
	 
	 //begin code to go to read the message
	 $scope.readMessage = function(hosp_id,sample_id,notifyid,np){
		...
		// if(Session_id){
				...
				.success(function(data) {
			         ...
			         window.location.href = "readMessageDisplay.html";
	 ...
	 //end of code to go to read the message
	 
	 //begin code to update read notification
